...
<!DOCTYPE html>
<h1><u>Delete Swarm Services <br><br></u></h1>
<form action="removeclusterhelper.jsp" method="post" >
    <%
        ...
        for (int i = 0; i < UserContainers.length(); i++) {
            ...
            if (temp.getString("Id").length()>3) {
                out.println("<h2> Service:  " + temp.getString("port") + "        " + "<input type='submit' value='Delete' name=" + temp.getString("Id") + "> <br></h2>");
            }
